...
class TwoRoomEnv(BabaIsYouEnv):
    ...
    def _gen_grid(self, width, height, params=None):
        ...
        self.win_obj = obj1 if self.color_in_rule else obj1[1]
        self.win_rule = (
            f"{obj1[0]} {obj1[1]} is win"
            if self.color_in_rule
            else f"{obj1[1]} is win"
        )
        ...
        if self.break_win_rule:
            ...
            break_rule(self, (self.win_obj, "win"), new_pos=self.right_pushable, block_idx=block_idx)
