...
RULE_COLORS = {
    # palette_legend.json palette_hash=2ba22c763864f4af, solid-v1.
    "is": np.array([195, 105, 255]),
    "door": np.array([60, 195, 0]),
    "key": np.array([195, 135, 30]),
    "ball": np.array([240, 0, 180]),
    "baba": np.array([45, 15, 165]),
    "wall": np.array([0, 60, 255]),
    "win": np.array([0, 255, 255]),
    "you": np.array([180, 255, 120]),
    "stop": np.array([255, 15, 0]),
    "push": np.array([120, 0, 255]),
    "lose": np.array([0, 150, 150]),
    "pull": np.array([0, 255, 60]),
    "move": np.array([105, 195, 210]),
    "open": np.array([255, 150, 150]),
    "shut": np.array([255, 240, 0]),
    "red": COLORS["red"],
    "green": COLORS["green"],
    "blue": COLORS["blue"],
...
class RuleBlock(WorldObj):
    ...
    def render(self, img):
        color = RULE_COLORS.get(self.name, np.array([235, 235, 235]))
        fill_coords(img, point_in_rect(0.06, 0.94, 0.06, 0.94), color)
